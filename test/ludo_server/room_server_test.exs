defmodule LudoServer.RoomServerTest do
  ...
  test "Move pawn to a square which already have another player pawn if the square is not safe square should capture" do
    room = %Room{
      room_id: "room_123",
      score: 6,
      current_player_seat: 1,
  ...
  test "Move pawn to a square which already have another player pawn if the square is not safe square should not capture" do
    room = %Room{
      room_id: "room_123",
      score: 6,
      current_player_seat: 1,
      players: [
        %Player{
          ...
          seat: 1,
          pawns: [
            %Pawn{no: 1, position_number: 14, group: "COMMUNITY"}
          ]
        },
        %Player{
          id: "player_346",
    ...
    {:noreply, room} =
      RoomServer.handle_cast(
        {:capture_pawn, "player_123", %Pawn{no: 1, position_number: 14, group: "COMMUNITY"}},
        room
      )
    ...
    assert %LudoServer.Pawn{group: "COMMUNITY", no: 1, position_number: 14} = captured_pawn
  end
end
